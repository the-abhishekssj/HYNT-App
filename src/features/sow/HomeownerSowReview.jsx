      ...
      <div className="px-4 py-5">
        <section className="pb-5">
          <div className="flex items-center justify-between gap-3">
            <div>
              <p className="text-[18px] font-extrabold leading-6 text-black">{project.projectName}</p>
              <p className="mt-1 text-[12px] font-medium leading-[18px] text-[#6f6f6f]">Designer: {project.designerName} | {project.location}</p>
            </div>
            <span className="rounded-full bg-[#f2f2f2] px-3 py-1 text-[10px] font-bold uppercase tracking-[0.08em] text-[#6f6f6f]">Review</span>
          </div>
          ...
          <div className="mt-4 grid grid-cols-3 gap-2">
            <div className="flex min-h-[56px] flex-col items-center justify-center rounded-xl border border-[#e2e2e2] bg-white px-2.5 py-2 text-center">
              <p className="text-[10px] font-bold leading-[14px] text-[#7b7b7b]">Type</p>
              <p className="mt-0.5 text-[13px] font-extrabold leading-[19px]">{project.projectType}</p>
            </div>
            <div className="flex min-h-[56px] flex-col items-center justify-center rounded-xl border border-[#e2e2e2] bg-white px-2.5 py-2 text-center">
              <p className="text-[10px] font-bold leading-[14px] text-[#7b7b7b]">Value</p>
              <p className="mt-0.5 text-[13px] font-extrabold leading-[19px]">INR {project.budgetLabel}</p>
            </div>
            <div className="flex min-h-[56px] flex-col items-center justify-center rounded-xl border border-[#e2e2e2] bg-white px-2.5 py-2 text-center">
              <p className="text-[10px] font-bold leading-[14px] text-[#7b7b7b]">Handover</p>
              <p className="mt-0.5 text-[13px] font-extrabold leading-[19px]">{project.handoverMonth}</p>
            </div>
          </div>
        </section>
        ...
        <section className="space-y-3 py-5">
          ...
          <ClientSection index="2" title="Scope - room wise" open={openSections.scope} onToggle={() => toggleSection('scope')}>
            ...
            <button type="button" onClick={() => setView('summary')} className="mt-3 flex items-center gap-2 rounded-xl border border-[#e0e0e0] bg-[#fbfbfb] px-3 py-2 text-[11px] font-bold text-black">
              <NotePencil size={14} />
              Add a scope remark
            </button>
          </ClientSection>
          ...
          <ClientSection index="4" title="Budget estimate" open={openSections.budget} onToggle={() => toggleSection('budget')}>
            <div className="space-y-3 text-[12px]">
              ...
              <button type="button" onClick={() => setView('summary')} className="flex items-center gap-2 rounded-xl border border-[#e0e0e0] bg-[#fbfbfb] px-3 py-2 text-[11px] font-bold text-black">
                <NotePencil size={14} />
                Add a budget remark
              </button>
            </div>
    ...
    <section className="mx-auto w-full max-w-[390px] pb-[132px] pt-[56px]">
      ...
      <div className="space-y-3 px-4 py-5">
        <article className="rounded-2xl border border-[#e1e1e1] bg-white p-4">
          <p className="text-[12px] font-bold uppercase tracking-[0.08em] text-[#777777]">Scope feedback</p>
          <textarea
            value={remarks.scope}
            ...
            className="mt-3 min-h-24 w-full rounded-2xl border border-[#e0e0e0] bg-[#fbfbfb] px-4 py-3 text-[12px] leading-5 text-black outline-none"
          />
        </article>
        <article className="rounded-2xl border border-[#e1e1e1] bg-white p-4">
          <p className="text-[12px] font-bold uppercase tracking-[0.08em] text-[#777777]">Budget feedback</p>
          <textarea
    ...
    <section className="mx-auto w-full max-w-[390px] pb-[132px] pt-[56px]">
      ...
      <div className="px-4 py-5">
        <article className="rounded-2xl border border-[#e1e1e1] bg-white p-5 text-center">
          ...
          <p className="mt-2 text-[12px] leading-5 text-[#6f6f6f]">Your designer has been asked to revise the SOW. Review the revised version below when it is ready.</p>
        </article>
      </div>
      ...
      <div className="space-y-3 px-4 py-5">
        <article className="rounded-2xl border border-[#e1e1e1] bg-white p-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-[13px] font-bold text-black">Your remarks were actioned.</p>
              <p className="mt-1 text-[11px] leading-5 text-[#6f6f6f]">Kitchen scope now includes granite countertop and chimney provision. Budget rationale remains documented for the original scope value.</p>
            </div>
          </div>
        </article>

        <article className="rounded-2xl border border-[#e1e1e1] bg-white p-4">
          <p className="text-[12px] font-bold uppercase tracking-[0.08em] text-[#777777]">Updated kitchen scope</p>
          <p className="mt-2 text-[11px] leading-5 text-black">Modular L-shape, granite countertop, soft-close shutters, chimney provision included</p>
        </article>

        <article className="rounded-2xl border border-[#e1e1e1] bg-white p-4">
          <p className="text-[12px] font-bold uppercase tracking-[0.08em] text-[#777777]">Budget note from designer</p>
          <p className="mt-2 text-[11px] leading-5 text-black">The 18L estimate protects execution quality and keeps the selected scope intact after the finish upgrade.</p>
        </article>
      </div>
    ...
    <section className="mx-auto w-full max-w-[390px] pb-[132px] pt-[56px]">
      ...
      <div className="px-4 py-5">
        <article className="rounded-2xl border border-[#e1e1e1] bg-white p-5 text-center">
          ...
          <p className="mt-2 text-[12px] leading-5 text-[#6f6f6f]">An OTP was sent to your registered mobile number. Verifying it completes your acceptance of this Scope of Work.</p>
    ...
    <section className="mx-auto w-full max-w-[390px] pb-[132px] pt-[56px]">
      ...
      <div className="space-y-3 px-4 py-5">
        <article className="rounded-2xl border border-[#e1e1e1] bg-white p-5 text-center">
          ...
          <h2 className="mt-4 text-[22px] font-extrabold leading-7 text-black">SOW signed</h2>
          <p className="mt-2 text-[12px] leading-5 text-[#6f6f6f]">Your project is officially confirmed. The executed Scope of Work is now ready for download and handoff.</p>
        </article>
